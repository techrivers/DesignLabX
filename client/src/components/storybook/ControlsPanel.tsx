    ...
    <div className="w-80 bg-surface border-l border-border flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        <div className="pt-4 border-t border-border">
          <h4 className="text-xs font-medium text-muted-foreground mb-3">Custom Styles</h4>
          <div className="space-y-3">
            {/* Background Color */}
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-2">Background Color</label>
              <input
                type="color"
                value={controls.customStyles?.backgroundColor || "#ffffff"}
                onChange={(e) => onUpdateControl("customStyles", { 
                  ...controls.customStyles, 
                  backgroundColor: e.target.value 
                })}
                className="w-full h-8 border border-border rounded focus:outline-none focus:ring-2 focus:ring-primary bg-background"
              />
            </div>
            ...
            <div>
              ...
              <input
                type="color"
                value={controls.customStyles?.color || "#000000"}
                onChange={(e) => onUpdateControl("customStyles", { 
                  ...controls.customStyles, 
            ...
            {/* Border */}
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-2">Border</label>
              <input
                type="text"
                value={controls.customStyles?.border || ""}
                onChange={(e) => onUpdateControl("customStyles", { 
                  ...controls.customStyles, 
            ...
            {/* Border Radius */}
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-2">Border Radius</label>
              <input
                type="text"
                value={controls.customStyles?.borderRadius || ""}
                onChange={(e) => onUpdateControl("customStyles", { 
                  ...controls.customStyles, 
            ...
            <div>
              ...
              <input
                type="text"
                value={controls.customStyles?.padding || ""}
                onChange={(e) => onUpdateControl("customStyles", { 
                  ...controls.customStyles, 
            ...
            <div>
              ...
              <input
                type="text"
                value={controls.customStyles?.margin || ""}
                onChange={(e) => onUpdateControl("customStyles", { 
                  ...controls.customStyles, 
            ...
            {/* Font Size */}
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-2">Font Size</label>
              <input
                type="text"
                value={controls.customStyles?.fontSize || ""}
                onChange={(e) => onUpdateControl("customStyles", { 
                  ...controls.customStyles, 
            ...
            {/* Font Weight */}
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-2">Font Weight</label>
              <select
                value={controls.customStyles?.fontWeight || ""}
                onChange={(e) => onUpdateControl("customStyles", { 
                  ...controls.customStyles, 
            ...
            <div>
              ...
              <input
                type="text"
                value={controls.customStyles?.width || ""}
                onChange={(e) => onUpdateControl("customStyles", { 
                  ...controls.customStyles, 
            ...
            <div>
              ...
              <input
                type="text"
                value={controls.customStyles?.height || ""}
                onChange={(e) => onUpdateControl("customStyles", { 
                  ...controls.customStyles, 
            ...
            {/* Box Shadow */}
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-2">Box Shadow</label>
              <input
                type="text"
                value={controls.customStyles?.boxShadow || ""}
                onChange={(e) => onUpdateControl("customStyles", { 
                  ...controls.customStyles, 
            ...
            <div>
              ...
              <input
                type="text"
                value={controls.customStyles?.transform || ""}
                onChange={(e) => onUpdateControl("customStyles", { 
                  ...controls.customStyles, 
            ...
            {/* Opacity */}
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-2">Opacity</label>
              <input
                type="range"
                min="0"
                max="1"
                step="0.1"
                value={controls.customStyles?.opacity || 1}
                onChange={(e) => onUpdateControl("customStyles", { 
                  ...controls.customStyles, 
              ...
              <div className="text-xs text-muted-foreground mt-1">
                Current: {controls.customStyles?.opacity || 1}
              </div>
            </div>

            {/* Clear Styles Button */}
            <button
              onClick={() => onUpdateControl("customStyles", {})}
              className="w-full px-3 py-2 text-xs bg-muted hover:bg-muted/80 rounded flex items-center justify-center text-muted-foreground"
            >
              Clear Custom Styles
            </button>
          </div>
